      ...
      >
        <div className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <label className="block text-sm font-medium text-slate-700">
              {goalType === "weekly" ? "Times per week" : "Times per day"}
              <input
                type="number"
                min={1}
                max={20}
                ...
                {WEEKDAY_ORDER.map((dayKey) => (
                  ...
                  >
                    <input
                      ...
                      onChange={(event) =>
                        onChangeActiveDay(dayKey, event.target.checked)
                      }
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              ...
              onClick={() => onSave(nameValue, activeDaysValue, targetValue)}
            >
              Save
            </button>
          </div>
